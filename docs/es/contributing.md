...
- **Editar la documentación**: cada doc humano es bilingüe — actualiza `docs/en/` y `docs/es/` en el mismo cambio. Los archivos de rol, `templates/` y el baseline de sesión quedan en inglés (la capa canónica para la máquina).
